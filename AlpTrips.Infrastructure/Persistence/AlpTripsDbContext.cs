...
{
    public class AlpTripsDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Trip>(eb =>
            {
                ...
                eb.HasData(new Trip() { Id = 1, CreatedDate = DateTime.Now, Name = "Weisskugel 3739m npm", Description = "3 najwyższy sczyt Austrii", Level = 2, MountainRange = "Alpy Ötztalskie", Link = "https://dzikumaniak.pl/2022/10/28/weiskugel/", UserId = 1
                },
